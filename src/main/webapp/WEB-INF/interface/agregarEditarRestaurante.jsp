...
<html>
    <head>        
        <title>Interface Restaurante</title>
                    ...
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-header">
                                <h4>
                                    ${param.accion=="agregar"?"Agregar Restaurante.":param.accion=="editar"?"Editar Restaurante.":"XXX"}
                                </h4>
                            </div>
                            <form id="fmrConceptoUP" class="was-validated">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input name="id" type="hidden" value="${cc != null ? cc.idRestaurante : "0"}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="${cc!=null ? cc.direccion: ""}"
...
<script>
            $(document).ready(function () {
                $("#btnConceptoUP").on("click", function () {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/RestauranteController",
                        data: datos,
                        ...
                        complete: function (jqXHR, textStatus) {
                            ...
                            window.location = "${pageContext.request.contextPath}/RestauranteController";
                        }
                    });
                });
            });
